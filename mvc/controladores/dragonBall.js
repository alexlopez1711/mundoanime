...
function bloquearTarjetasFacil() {
  for (let i = 0; i <= 15; i++) {
      ...
      tarjetaBloqueadaFacil.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${numeroFacil[i]}.jpg">`;
...
function destaparFacil(id) {
  ...
  if (tarjetasDestapadasFacil == 1) {
      ...
      tarjeta1Facil.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${primerResultadoFacil}.jpg">`;
      clickAudio.play();
      ...
      tarjeta2Facil.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${segundoResultadoFacil}.jpg">`;
      clickAudio.play();
...
function bloquearTarjetasDificil() {
    for (let i = 16; i <= 35; i++) {
        ...
        tarjetaBloqueadaDificil.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${numeroDificil[i - 16]}.jpg">`;
...
function destaparDificil(id) {
    ...
    if (tarjetasDestapadasDificil == 1) {
        ...
        tarjeta1Dificil.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${primerResultadoDificil}.jpg">`;
        clickAudio.play();
        ...
        tarjeta2Dificil.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${segundoResultadoDificil}.jpg">`;
        clickAudio.play();
...
function bloquearTarjetasExperto() {
    for (let i = 36; i <= 65; i++) {
        ...
        tarjetaBloqueadaExperto.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${numeroExperto[i - 36]}.jpg">`;
...
function destaparExperto(id) {
    ...
    if (tarjetasDestapadasExperto == 1) {
        ...
        tarjeta1Experto.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${primerResultadoExperto}.jpg">`;
        clickAudio.play();
        ...
        tarjeta2Experto.innerHTML = `<img src="../img/modalimg/goku/dragonMemoria/${segundoResultadoExperto}.jpg">`;
        clickAudio.play();
